...
const DashboardWidgets = () => {
  const [ordersComparePercentage, setOrdersComparePercentage] = useState(null);
  const [userComparePercentage, setUserComparePercentage] = useState(null);
            ...
            <div className="flex items-center p-5 justify-between">
              ...
              <div>
                <CircularProgressWithLabel
                  className="dark:text-white tex-black"
                  value={ordersComparePercentage?.percentChange > 0 ? 100 : 0}
                  open={open}
                />
                <h5 className="text-center pt-4 dark:text-white tex-black">
